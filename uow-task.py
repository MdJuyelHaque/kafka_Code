...
#consumer
  ...
  for message in consumer:
      ...
      print(table_name)
      myclient = pymongo.MongoClient("mongodb+srv://mongopy:047T35k8br1lef9F@db-mongodb-f6a21137.mongo.ondigitalocean.com/admin?tls=true&authSource=admin&replicaSet=db-mongodb")
      mydb = myclient["task1"]
    ...
    #   x = mycol.insert_one(payload)
      ...
      mydb.task1.update_many(res,{"$set":  payload},upsert=True) 
...
#       print("The filtered dictionary is : " + str(res))      
#       mydb.UnitOfWork_New.update_many(res,{"$set":  payload},upsert=True) 
#       # ({}, {$set :{"status": 1}}, false, true)
#       # mydb.UnitOfWork_New.delete_many({"UnitOfWorkId":val})
